          ...
          <div className="navbar row">
            ...
            <div className="col-md-2">
              <span className="alignment text-center" style={{marginLeft:"20%"}}>
                <FaBell style={{ width: "35px", height: "35px", cursor: "pointer" }} className="text-white" />
                <FaWifi style={{ width: "35px", height: "35px", marginLeft: "15px", cursor: "pointer" }} className={`icons ${navigator.onLine ? "active" : "deactive"}`} />
              </span>
            </div>
